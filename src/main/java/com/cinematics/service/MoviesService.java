...
import com.cinematics.repository.MoviesRepository;
import com.cinematics.service.dto.MoviesDTO;
import com.cinematics.web.rest.errors.BadRequestAlertException;
import com.cinematics.web.rest.errors.MovieAlreadyExistsException;
...
public class MoviesService {
    ...
    public List<Movies> saveMovies(List<MoviesDTO> movieDTOs) {
    	List<Movies> movies = new ArrayList<>();
    	movieDTOs.forEach(movieDTO -> {

    		if (movieDTO.getId() != null) {
    			throw new BadRequestAlertException("A new movie cannot already have an ID", "movieManagement", "idexists");
    		} else if (moviesRepository.findOneById(movieDTO.getId())) {
